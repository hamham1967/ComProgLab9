...
const char* resource = "https://maker.ifttt.com/trigger/publish_sensor/with/key/bUWXamhvz6gTF3D877Wn3F";
...
void makeIFTTTRequest() {
 ...
 float temp,humid;{
  ...
  String jsonObject = String("{\"value1\":\"") + String(temperature) + "\",\"value2\":\"" + String(humidity)  + "\"}";
